  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 py-12 px-4 font-sans">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-2xl border border-slate-200">
        ...
        <h2 className="text-2xl font-bold text-slate-900 text-center mb-1">Reset Password</h2>
        <p className="text-slate-500 text-center mb-8 text-sm font-medium">Enter your new secure password</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            <Lock size={20} /> {loading ? 'Resetting...' : 'Reset Password'}
          </button>
        </form>
      </div>
    </div>
