...
import { User, Shield, Key, Mail, Building, MapPin, Sparkles, Check } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] shadow-xl shadow-slate-200/20 dark:shadow-none border border-slate-200 dark:border-slate-800 p-8">
              <div className="flex items-center gap-3 mb-8 pb-6 border-b border-slate-100 dark:border-slate-800/80">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">Publicly displayed information</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="email" defaultValue="vinith.k@uohyd.ac.in" className="w-full pl-11 pr-4 py-3.5 bg-slate-50 dark:bg-slate-950/50 backdrop-blur-md rounded-2xl text-sm text-slate-900 dark:text-white outline-none border border-slate-200 dark:border-slate-800 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all font-bold" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 px-1">Department</label>
                  <div className="relative">
                    <Building className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                    <input type="text" defaultValue="Computer Science" className="w-full pl-11 pr-4 py-3.5 bg-slate-50 dark:bg-slate-950/50 backdrop-blur-md rounded-2xl text-sm text-slate-900 dark:text-white outline-none border border-slate-200 dark:border-slate-800 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all font-bold" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 px-1">Location / Hostel</label>
                  <div className="relative">
                    <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                    <input type="text" defaultValue="Hostel K, Room 204" className="w-full pl-11 pr-4 py-3.5 bg-slate-50 dark:bg-slate-950/50 backdrop-blur-md rounded-2xl text-sm text-slate-900 dark:text-white outline-none border border-slate-200 dark:border-slate-800 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all font-bold" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="xl:col-span-4">
           <div className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-[2.5rem] p-8 text-white shadow-xl shadow-blue-500/20 relative overflow-hidden group">
            ...
            <p className="text-blue-100 font-medium text-sm mb-8 leading-relaxed">Your account is fully secured and verified within the UoH ecosystem.</p>
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="flex justify-between items-center p-4 bg-black/20 backdrop-blur-md rounded-2xl border border-white/10">
                ...
                <span className="text-white text-sm font-black">2 Devices</span>
              </div>
              <div className="flex justify-between items-center p-4 bg-black/20 backdrop-blur-md rounded-2xl border border-white/10">
