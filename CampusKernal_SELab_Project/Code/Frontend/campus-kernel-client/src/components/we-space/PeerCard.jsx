...
export default function PeerCard({ peer, myTags, onMessage }) {
  ...
  return (
    <div className="p-5 bg-white border border-slate-100 rounded-3xl hover:border-blue-300 hover:shadow-xl hover:shadow-blue-500/5 transition-all group">
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center font-bold text-white shadow-lg shadow-blue-200">
              {peer.name[0]}
            </div>
            {peer.status === 'Online' && (
      ...
      <button 
        ...
        className="w-full py-2.5 bg-slate-50 text-blue-600 rounded-2xl text-xs font-bold flex items-center justify-center gap-2 group-hover:bg-blue-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-blue-200 transition-all active:scale-95"
      >
